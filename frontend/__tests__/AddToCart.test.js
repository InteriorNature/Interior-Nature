...
//ApolloConsumer when we have to manually manipulate data thru apollo
  it('adds an item to cart when clicked', async () => {
    ...
    // console.log(me); expect cart to be empty
    ...
    //OR use const res = await above
    //AND const me2 = res.data.me
