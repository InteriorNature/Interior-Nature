...
var _jsxFileName = "C:\\Users\\klsno\\desktop\\studies\\advanced-react\\sick-fits\\frontend\\components\\UpdateItem.js";
...
function (_Component) {
  ...
  function UpdateItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {//only putting in things that have changed
    });
  ...
  _createClass(UpdateItem, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
        ...
        return (//if everything is a render prop, how do I access
...
})(["box-shadow:0 0 5px 3px rgba(0,0,0,0.05);background:rgba(0,0,0,0.02);border:5px solid white;padding:20px;font-size:1.5rem;line-height:1.5;font-weight:600;label{display:block;margin-bottom:1rem;}input,textarea,select{width:100%;padding:0.5rem;font-size:1.35rem;border:1px solid black;&:focus{outline:0;border-color:", ";}}button,input[type='submit']{width:auto;background:#ff9336;color:white;border:0;border-radius:5px;font-size:2rem;font-weight:600;padding:0.5rem 1.2rem;}fieldset{border:0;padding:0;&[disabled]{opacity:0.5;}&::before{height:10px;content:'';display:block;background-image:linear-gradient(to right,#fa6003 0%,#ffca9a 50%,#fa6003 100%);}&[aria-busy='true']::before{background-size:50% auto;animation:", " 0.5s linear infinite;}}"], function (props) {
...
var _jsxFileName = "C:\\Users\\klsno\\desktop\\studies\\advanced-react\\sick-fits\\frontend\\pages\\update.js";
